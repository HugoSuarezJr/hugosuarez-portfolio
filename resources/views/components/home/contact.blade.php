<section id="contact" class="bg-white dark:bg-primary scroll-mt-12">
    <div class="overflow-hidden py-20 lg:py-[120px] relative z-10">
        <div class="container">
                    ...
                    <div class="bg-white dark:bg-slate-900 relative rounded-lg p-8 sm:p-12 shadow-lg">
                        <form action="/contact/submit" method="POST" x-data="{
                            ...
                            <template x-if="successMessage">
                                <div x-text="successMessage" class="py-4 px-6 bg-green-600 text-gray-100 mb-4 rounded">
                                </div>
                            </template>
                            @csrf
                            <div class="mb-6">
